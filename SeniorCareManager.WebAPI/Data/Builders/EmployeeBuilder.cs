    ...
    public class EmployeeBuilder
    {
        public static void Build(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Employee>().HasData(new List<Employee>
            {
                    ...
                    new Employee(3, "Carlos Pereira", "456.789.123-00", "(31) 98765-4321", "carlos.pereira@email.com", new DateTime(2025, 9, 21, 10, 30, 0, DateTimeKind.Utc), "MG", "Belo Horizonte", "Rua C", "30000-000", "789", "Savassi", StatusEmployee.FIRED, 3)
