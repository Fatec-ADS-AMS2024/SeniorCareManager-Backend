...
public class ManufacturerDTO
{
    ...
    [StringLengthValidator(150, ErrorMessage = "Nome corporativo deve ter no máximo 150 caracteres.")]
    public string CorporateName { get; set; }

    [RequiredValidator(ErrorMessage = "Nome comercial obrigatório.")]
    [StringLengthValidator(150, ErrorMessage = "Nome comercial deve ter no máximo 150 caracteres.")]
    ...
    [ExtractNumbers]
    [RemoveSpaces]
    [StringLengthValidator(18, ErrorMessage = "CPF/CNPJ deve ter no máximo 18 caracteres (formatado).")]
    ...
    [ExtractNumbers]
    [PhoneFormat]
    [StringLengthValidator(15, ErrorMessage = "Telefone deve ter no máximo 15 caracteres.")]
    public string Phone { get; set; }

    [EmailValidator(ErrorMessage = "O e-mail informado não é válido.")]
    [RequiredValidator(ErrorMessage = "O e-mail é obrigatório.")]
    [RemoveSpaces]
    [StringLengthValidator(100, ErrorMessage = "O e-mail deve ter no máximo 100 caracteres.")]
